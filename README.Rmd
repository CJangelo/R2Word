...
R2Word, an R package that uses `flextable` functions to quickly and easily creating MS Word tables.
...
See Vignettes for some concise examples of how the functions can help workflow.
